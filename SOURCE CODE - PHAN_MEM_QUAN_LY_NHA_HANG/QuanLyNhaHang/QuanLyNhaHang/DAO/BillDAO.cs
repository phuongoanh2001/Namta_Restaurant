...
namespace QuanLyNhaHang.DAO
{
    public class BillDAO
    {
        ...
        {
            string query = "UPDATE dbo.HOADON SET NgayRa = GETDATE(), TrangThai = 1, " + "GiamGia = " + discount + ", TongTT = " + totalPrice + " WHERE MaHD = " + id;
        ...
        //Phân trang hóa đơn, mỗi trang chỉ mặc định 10 hóa đơn
        {
